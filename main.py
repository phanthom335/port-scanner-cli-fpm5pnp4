    """
    Port Scanner Cli Fpm5pnp4
    =========================
    Developer-friendly CLI that helps you search projects in seconds.
    ...
    APP_NAME    = "Port Scanner Cli Fpm5pnp4"
    APP_VERSION = "1.0.0"
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-friendly CLI that helps you search projects in seconds.")
